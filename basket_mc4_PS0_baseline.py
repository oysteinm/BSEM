...
Usage (PowerShell):
    ...
    python .\basket_mc4_PS0_baseline.py --force
    python .\basket_mc4_PS0_baseline.py --samples 2000 --tune 2000 --chains 4
...
# =============================================================================
# SPEC CONFIG (PS0 - Baseline)
# =============================================================================

SPEC_ID = "PS0_baseline"
...
PRIOR_CONFIG = {
    ...
    "lambda_sigma": 0.5,
    "psi_sigma": 1.0,
    "notes": "Baseline weakly informative priors used in main revision rerun."
}
