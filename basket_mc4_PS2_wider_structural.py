...
Usage (PowerShell):
    ...
    python .\basket_mc4_PS2_wider_structural.py --force
    python .\basket_mc4_PS2_wider_structural.py --samples 2000 --tune 2000 --chains 4
...
SPEC_ID = "PS2_wider_structural"

PRIOR_PROFILE = "wider_structural"
PRIOR_CONFIG = {
    "beta_sigma": 2.0,
    "lambda_mu": 0.7,
    "lambda_sigma": 0.5,
    "psi_sigma": 1.0,
    "notes": "Tests sensitivity to weaker regularization of structural effects."
}
