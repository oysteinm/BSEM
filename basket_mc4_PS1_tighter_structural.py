...
Usage (PowerShell):
    ...
    python .\basket_mc4_PS1_tighter_structural.py --force
    python .\basket_mc4_PS1_tighter_structural.py --samples 2000 --tune 2000 --chains 4
...
SPEC_ID = "PS1_tighter_structural"

PRIOR_PROFILE = "tighter_structural"
PRIOR_CONFIG = {
    "beta_sigma": 0.5,
    "lambda_mu": 0.7,
    "lambda_sigma": 0.5,
    "psi_sigma": 1.0,
    "notes": "Tests whether substantive conclusions depend on stronger shrinkage of structural effects."
}
